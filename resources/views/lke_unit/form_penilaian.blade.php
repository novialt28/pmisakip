...
<section id="container">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="display-4 mt-3 mb-3">Lembar Kerja Unit | Form Penilaian</h2>
            </div>
        </div>
...
<div class="row justify-content-center mt-3">
    ...
    <table class="table mt-3">
        ...
        <tbody>
          ...
          <tr>
            <th scope="row">11</th>
            <td>Setiap pegawai merumuskan dan menetapkan Perencanaan Kinerja</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">3</th>
            <td>Target yang ditetapkan dalam Perencanaan Kinerja telah dicapai dengan baik, atau setidaknya masih on the right track</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">8</th>
            <td>Setiap Pegawai memahami dan peduli, serta berkomitmen dalam mencapai kinerja yang telah direncanakan</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">1</th>
            <td>Pimpinan selalu teribat sebagai pengambil keputusan (Decision Maker) dalam mengukur capaian kinerja</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">7</th>
            <td>Pengukuran capaian kinerja telah memanfaatkan Teknologi Informasi (Aplikasi)</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">3</th>
            <td>Dokumen Laporan Kinerja telah menginfokan perbandingan realisasi kinerja dengan target tahunan</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">4</th>
            <td>Dokumen Laporan Kinerja telah menginfokan perbandingan realisasi kinerja dengan target jangka menengah</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">5</th>
            <td>Dokumen Laporan Kinerja telah menginfokan perbandingan realisasi kinerja dengan realisasi kinerja tahun-tahun sebelumnya</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
          ...
          <tr>
            <th scope="row">7</th>
            <td>Dokumen Laporan Kinerja telah menginfokan kualitas atas capaian kinerja beserta upaya nyata dan/atau hambatannya</td>
            <td></td>
            <td><div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" id="nilai" name="nilai"  autofocus>
                  <option selected>Nilai</option>
